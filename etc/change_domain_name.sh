#!/bin/sh
OLD_LDAP_URL="${OLD_LDAP_URL:=ldap://deliflow-ldap-server:389}"
LDAP_URL="${LDAP_URL:=ldap://deliflow-ldap-server:389}"
...
sed -i -- "s/${OLD_LDAP_URL}/${TEMP_LDAP_URL}/g" /etc/cas/cas.properties